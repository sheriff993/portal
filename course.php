...
?>
	...
	<form method="POST" action="course1.php">
		<div class="form-group">
			...
			<input clsss="col-sm-4 col-md-2" type="text" name="ccode" placeholder="Example: Com001" required />
		</div>
		<div class="form-group">
			<label>Course Title</label><br>
			<input clsss="col-sm-4 col-md-2" type="text" name="ctitle" placeholder="Example: Digital Electronics" required />
		</div>
		<div class="form-group">
			<label>Course Unit</label><br>
			<input clsss="col-sm-4 col-md-2" type="number" name="cunit" placeholder="Example: 2" required />
		</div>
